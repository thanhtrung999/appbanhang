...
public class ThongTinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng trungtam = new LatLng(20.992925, 105.849399);
        mMap.addMarker(new MarkerOptions().position(trungtam).title("Trung Tâm Thành trung").snippet("134 trương dinh quạn hai ba").icon(BitmapDescriptorFactory.defaultMarker()));
        mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
        CameraPosition cameraPosition=new CameraPosition.Builder().target(trungtam).zoom(30).build();
